...
public class Smart_Bear_Order{
    ...
    SBViewAllOrdersPage viewAllOrdersPage = new SBViewAllOrdersPage ();


    @Given("User is logged into SmartBear Tester account and on Order page")
    public void user_is_logged_into_SmartBear_Tester_account_and_on_Order_page() {
        Driver.getDriver().get("http://secure.smartbearsoftware.com/samples/testcomplete12/WebOrders/login.aspx");
        sbLoginPage.username.sendKeys("Tester");
        sbLoginPage.password.sendKeys("test");
    ...
    public void user_verifies_is_in_the_table(String string) {
        ...
        System.out.println (viewAllOrdersPage.newOrderNameCell.getText ());
